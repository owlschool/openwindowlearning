<?php
/**
 * Template Name: Life After Ged
 * Description: A Page Template to display Life After Ged archives with the sidebar.
 *
 * @package  WellThemes
 * @file     page-life-after-ged.php
		...
		<?php
			...
			if ( get_query_var('paged') ) {
				...
				$paged = 1;
		    		...
		    		$args = array(
					'post_status' => 'publish',
	                                'category_name' => 'life-after-ged-spanish',
        	                        'post_type' => 'page',
					 'paged' => $paged
				);
                        }
