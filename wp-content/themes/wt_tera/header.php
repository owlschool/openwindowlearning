...
<body <?php body_class(); ?>>
<style type="text/css">
#header { background-color: black; color: white; padding-bottom: 20px; }
#header #container.top-page-header, #header .top-page-header-full-width { background-color:rgb(140, 199, 19); color: white; }
}
</style>
    <header id="header">
