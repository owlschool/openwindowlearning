...
<div id="ld_activity_actions" class="sidebar-name">
	<a href="<?php echo admin_url('edit.php?quiz_export_submit=1&nonce-sfwd=' . wp_create_nonce('sfwd-nonce') . '&post_type=sfwd-quiz&page=sfwd-lms_sfwd_lms.php_post_type_sfwd-quiz') ?>" class="activity_export_quiz"><?php echo __('Export Quiz Data', 'ld_propanel') ?></a> ::
	<a href="<?php echo admin_url('edit.php?courses_export_submit=1&nonce-sfwd=' . wp_create_nonce('sfwd-nonce') . '&post_type=sfwd-courses&page=sfwd-lms_sfwd_lms.php_post_type_sfwd-courses') ?>" class="activity_export_course"><?php echo __('Export Course Data', 'ld_propanel') ?></a>
</div>
